        ...
        <div class="col-sm-12">
            <div class="card">
                <div class=" p-3 d-flex justify-content-between ">
                    ...
                    <span class=" card-title">{{ __('Practica') }}</span>

                    <a href="{{ route('practicas.create') }}" class="btn btn-primary btn-sm" data-placement="left">
                        {{ __('Crear Nuevo') }}
                    </a>
                </div>
                <div class="px-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger btn-sm" type="button"
                                                    wire:click="delete({{ $practica->id }})"
                                                    wire:confirm="¿Estas seguro de eliminar esta practica?">
